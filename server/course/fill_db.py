...
def add_pass_rate(course_list):
    ...
    for course_dict in course_info_list:
        course_response = requests.get(
            "https://grades.no/api/v2/courses/{}/grades/".format(course_dict["code"]))
...
limit = 100
offset = 0
next_url = "https://grades.no/api/v2/courses/?limit={}&offset={}".format(
    limit, offset)

# Fetch the total number of courses
count = requests.get(
    "https://grades.no/api/v2/courses/?limit=1").json()["count"]
